...
module.exports = (
  {
    title = "TheNimblegeek",
    description = "TheNimblegeek's personal site",
    url = "/",
    image = "/public/images/iamjas_profile.jpg",
    isHomePage = false, // Add this new parameter
  },
  content,
) => {
...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="//1.gravatar.com/userimage/176721085/98808ddecc017cf13867273e871125ae?size=256" />
...
<link href="https://fonts.googleapis.com/css2?family=Merriweather&display=swap" rel="stylesheet"/>
  ...
  <body>
    ...
    ${content}
    ${isHomePage ? "<footer><p>&copy; " + new Date().getFullYear() + " Jonas Achouri Sihlén. All rights reserved.</p></footer>" : ""}
  </body>
</html>
`;
};
